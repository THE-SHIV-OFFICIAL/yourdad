...
from SHIVMUSIC.utils.exceptions import AssistantErr, is_voice_chat_unavailable
...
VC_OFF_MSG = (
    "> **<tg-emoji emoji-id=\"6129782440157256336\">🥹</tg-emoji> ᴄᴏᴜʟᴅɴ'ᴛ ᴊᴏɪɴ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.**\n"
    "> \n"
    "> **<tg-emoji emoji-id=\"5294339927318739359\">🎙️</tg-emoji> ᴄʜᴇᴄᴋ ᴛʜᴀᴛ ɪᴛ ɪs ʟɪᴠᴇ ᴀɴᴅ ᴛʜᴀᴛ ᴛʜᴇ ᴀssɪsᴛᴀɴᴛ ᴄᴀɴ ᴀᴄᴄᴇss ᴛʜᴇ ɢʀᴏᴜᴘ.**"
)

def is_vc_off(e):
    return is_voice_chat_unavailable(e)

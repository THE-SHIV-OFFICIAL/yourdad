...
from ftmgram.enums import ChatType, ChatAction, ButtonStyle, ParseMode
...
async def start_pm(client, message: Message, _):
    loading_html = (
        ...
        f"{app.mention} <tg-emoji emoji-id=\"6082387600599944892\">🎧</tg-emoji></b><br/>"
        "<i>Preparing your music player...</i><br/>"
        "<b>Loading commands and playback controls</b></blockquote>"
    )
    loading_1 = await stream_typewriter_rich_message(
        client,
        message.chat.id,
        loading_html,

...
import random
import math
from ftmgram.types import CallbackQuery, InputMediaPhoto, InputMediaVideo, InlineKeyboardButton, InlineKeyboardMarkup
from ftmgram import filters
from ftmgram.errors import WebpageMediaEmpty
from ftmgram.enums import ButtonStyle, ChatMemberStatus
...
async def refresh_player_controls(chat_id, _, fallback_message=None):
    """Refresh the single tablet-style play/pause row without sending a duplicate card."""
    ...
    try:
        ...
        # The player may have been deleted; the callback message is the safest fallback.
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Toggle":
        ...
        await refresh_player_controls(chat_id, _, CallbackQuery.message)
    elif command == "Pause":
